...
pretty much all programming languages and look the same. This uniformity is by design and used to enforced by the use
of "local" Slice definitions. This way, when you port your code from one programming language to another, the Ice
portion of your code can essentially remain the same.

A downside of this uniformity is the Ice API and APIs generated by the Ice compiler often don't follow standard naming
