...
Slice comments that start with a triple slash (`///`) are doc comments. The Slice code generators use these special
comments as input for the doc comments they generate in the mapped languages.
