...
namespace [ZeroC.Slice.Codec][slice-codec-namespace] that can encode resp. decode a variety of types to or from byte
buffers. These structs are provided by the [ZeroC.Slice.Codec] assembly and referenced by the code generated by the
Slice compiler.
