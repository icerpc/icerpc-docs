...
implementing this dispatcher, you are responsible for creating this outgoing response.
...
In C#, the payload of an outgoing response is split into a payload and a payload continuation, just like the payload of an
