  ...
  return (
    <div className="mb-10 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2">
      <ExampleCard
        ...
        href="https://github.com/icerpc/icerpc-csharp/tree/0.5.x/examples/slice/"
      />
      <ExampleCard
        title="IceRPC + Protobuf"
        description="Example applications that use both IceRPC and Protobuf."
        href="https://github.com/icerpc/icerpc-csharp/tree/0.5.x/examples/protobuf"
      />
    </div>
  );
};
...
const ExampleCard = ({ title, description, href }: ExampleCardProps) => (
  <Link
    href={href}
    className="flex flex-col justify-start rounded-xl border bg-white p-6 shadow-xs dark:border-dark-border dark:bg-dark-accent"
  >
    ...
    <div className="mt-8 flex flex-col justify-between">
      ...
      <p className="my-0 mt-1 text-[13px] text-(--text-color-secondary) dark:text-white/80">
        {description}
      </p>
    </div>
  </Link>
