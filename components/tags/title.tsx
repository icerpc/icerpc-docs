...
export const Title = ({ title, description, path, readingTime }: Props) => {
  ...
  return (
    <div className="not-prose mb-10">
      ...
      <h1 className="bg-linear-to-b from-slate-800 to-black bg-clip-text pr-10 text-4xl font-bold leading-[2.65rem] text-transparent dark:text-white">
        {title}
      </h1>
      <h2 className="mb-3 mt-2 text-xl text-(--text-color-secondary) dark:text-white/60">
        {description}
      </h2>
    </div>
  );
