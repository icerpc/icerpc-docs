...
export const SideNav = ({ path }: SideNavProps) => {
  ...
  return (
    <nav className="sticky left-0 top-0 z-30 hidden h-screen w-60 overflow-y-auto overflow-x-hidden border-lightBorder bg-[#ffffff] pb-10 pl-6 pt-0 shadow dark:border-darkBorder dark:bg-[#26282c] lg:block">
