...
For compatibility with Ice, IceRPC always encodes 1.1 (on 2 bytes) as the Ice/Slice encoding version in encapsulations
even though IceRPC doesn't know anything about payload encoding. That's because:
