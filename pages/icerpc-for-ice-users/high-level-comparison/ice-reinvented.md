...
Ice is a one-stop solution for building network applications. You get a RPC framework and much more with Ice.
...
commercial license in order to use Ice in your applications.
This [dual-licensing][dual-licensing] model is a fair model that helped fund Ice's development; however, GPL has become
an uncommon license for modern software frameworks.
