...
A server address URI must have an empty path and no fragment. It can have query parameters; except for the `transport` parameter these parameters are transport-specific.
